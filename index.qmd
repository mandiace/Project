...
# NEED TO FIX LAND ISSUE
finaldata2020 |>
  ggplot() +
  geom_point(aes(x = population_density, y = diff_current), 
           alpha = 0.6, 
           color = "pink") + 
  labs(
    title = "Population Density and Total Population vs. Land Area",
...
finaldata2020 |>
  ggplot() +
  geom_point(aes(x = poverty_rate, y = diff_current)) + 
  geom_smooth(mapping = aes(x = poverty_rate, y = diff_current))
